      ...
      {activeTab === 'gallery' ? (
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-10">
          ...
          <div className="bg-white p-10 rounded-[3.5rem] border border-slate-100 shadow-xl space-y-8">
            ...
            <EditorSlider label="X Position" value={lights[0].posX} onChange={v => updateLight(lights[0].id, { posX: v })} />
            <EditorSlider label="Y Position" value={lights[0].posY} onChange={v => updateLight(lights[0].id, { posY: v })} />
            <EditorSlider label="Glow Size" value={lights[0].spread} min={10} max={200} onChange={v => updateLight(lights[0].id, { spread: v })} />
            <EditorSlider label="Brightness" value={lights[0].intensity} onChange={v => updateLight(lights[0].id, { intensity: v })} />
            <div className="pt-6">
              <VariationCard 
                name="Custom Mesh" 
                css={editorCss} 
